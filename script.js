...
const cyc1 = new Cycling([39, -12], 12, 40, 538);
...
class App {
  ...
  constructor() {
    ...
    //Change Runnig to walking and visa-versa
    inputType.addEventListener('change', this._toggleElevationFeild);

    //Move focus to worked on clicking
  ...
  _loadMap(position) {
    ...
    console.log(`Current location link ${link}`);
